...
from notify.boto3.docs.attr import document_attribute
from notify.boto3.docs.attr import document_identifier
from notify.boto3.docs.attr import document_reference
